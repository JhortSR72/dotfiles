# Generated by Powerlevel10k configuration wizard on 2026-08-26 at 05:58 CST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#1a1a24'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#ff00aa'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#ff00aa'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#ffffff'
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND='#c2fe0c'
...
typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_FOREGROUND='#ffffff'
